# Your stdlib service: nemo/twilio
...
example, `nemo/twilio/forward` would map to the first
...
The entry point to your function described in `f/forward/function.json`.
